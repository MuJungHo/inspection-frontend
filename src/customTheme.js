...
export const lighten_palette = {
    ...
    container: { background: "rgba(0, 0, 0, 0.12)", color: '#000', },
    divider: "rgba(0, 0, 0, 0.12)",
    boxShadow: ["unset", "0px 2px 1px -1px rgba(0,0,0,0.2),0px 1px 1px 0px rgba(0,0,0,0.14),0px 1px 3px 0px rgba(0,0,0,0.12)"],
    sidebar: { background: '#5594c9', color: '#fff', active: "#3b86b1", hover: "rgba(59, 134, 177, .5)" },
...
export const dark_palette = {
    ...
    container: { background: dark[300], color: '#fff', },
    divider: dark[300],
    boxShadow: ['0px 10px 15px -2px rgba(0, 18, 40, 1)', '0px 10px 15px -2px rgba(0, 18, 40, 1)'],
    sidebar: { background: dark[900], color: '#fff', active: dark[800], hover: "rgba(0, 135, 220, .5)" },
